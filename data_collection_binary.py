...
cv2.imwrite("C:\Users\Akash\Sign-Language-To-Text-and-Speech-Conversion-master\white.jpg",white)
...
while True:
    try:
        ...
        if hands:
            ...
            x, y, w, h = hand['bbox']
            image = frame[y - offset:y + h + offset, x - offset:x + w + offset]
            white = cv2.imread("C:\Users\Akash\Sign-Language-To-Text-and-Speech-Conversion-master\white.jpg")
